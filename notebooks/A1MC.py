...
def process_player(player_info):
    ...
    active = clean[clean["player_status"]=="Active"].head()
    retired = clean[clean["player_status"]=="Retired"].head()
    
    print("Display of first 10 Players in list and their status")
...
def process_org(win_by_org):
    ...
    show2019(win2019,win2020,win2021,win2022,year_earn_compare)
    
def show2019(win2019,win2020,win2021,win2022,year_earn_compare):
    ...
    plt.show()
    show2020(win2019,win2020,win2021,win2022,year_earn_compare)
    
def show2020(win2019,win2020,win2021,win2022,year_earn_compare):
    ...
    plt.gcf().set_size_inches(40, 20)
    plt.show()
    show2021(win2019,win2020,win2021,win2022,year_earn_compare)
    
def show2021(win2019,win2020,win2021,win2022,year_earn_compare):
    ...
    plt.gcf().set_size_inches(40, 20)
    plt.show()
    show2022(win2019,win2020,win2021,win2022,year_earn_compare)
    
def show2022(win2019,win2020,win2021,win2022,year_earn_compare):
    ...
    plt.gcf().set_size_inches(40, 20)
    plt.show()
    show_year_compare(win2019,win2020,win2021,win2022,year_earn_compare)
    
def show_year_compare(win2019,win2020,win2021,win2022,year_earn_compare):
    ...
    plt.show()
    show_top_5_by_year(win2019,win2020,win2021,win2022)
    
def show_top_5_by_year(win2019,win2020,win2021,win2022):
    print("Display of top 5 teams' ranking by year")
    win2019head=win2019.head()
    win2020head=win2020.head()
    win2021head=win2021.head()
    win2022head=win2022.head()
    win2019_style = win2019head.style.set_table_attributes("style='display:inline; margin-right:20px;'").set_caption("Earning Raank 2019")
    win2020_style = win2020head.style.set_table_attributes("style='display:inline; margin-right:20px;'").set_caption("Earning Raank 2020")
    win2021_style = win2021head.style.set_table_attributes("style='display:inline; margin-right:20px;'").set_caption("Earning Raank 2021")
    win2022_style = win2022head.style.set_table_attributes("style='display:inline'").set_caption("win2022")
